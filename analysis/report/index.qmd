...
![Atmospheric image to maintain visual engagement - replace with relevant scene](media/images/penguin-hero.png){.img-fluid}
...
We visualise these patterns using pre-generated
...
![Visual break - another atmospheric image maintaining engagement](media/images/penguin-hero.png){.img-fluid}
...
(r = -0.87). We visualise that relationship:
...
![Concluding visual - tie back to topic theme](media/images/penguin-hero.png){.img-fluid}
...
- Begin with exploration before modelling.
